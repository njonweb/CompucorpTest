...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:@localhost:3306/civicrm?new_link=true');
  }
}
...
$civicrm_root = 'D:/wamp64/www/drupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', 'D:/wamp64/www/drupal\\sites\\default\\files\\civicrm\\templates_c\\');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://drupal.local.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'f09feda7cced47d8b713532624c1201b');
}
...
// define( 'CIVICRM_MAIL_LOG', 'D:/wamp64/www/drupal\\sites\\default\\files\\civicrm\\templates_c\\/mail.log');
// }
